...
pub struct TrackedFiles {
    ...
    pub files_vec_signal: zoon::Mutable<Vec<TrackedFile>>, // Dedicated signal for efficient Vec access
                                    ...
                                    if all_done && !all_files_loaded_signaled {
                                        ...
                                        zoon::Task::start({
                                            async move {
                                                ...
                                                // TODO: Pass tracked_files when views functions have domain integration
                                                // crate::views::trigger_signal_value_queries(&current_files);
                                            }
                                        });
                                    }
                                } else {
...
// ELIMINATED: TRACKED_FILES_INSTANCE duplicate

// ===== PUBLIC API FUNCTIONS =====

// ELIMINATED: tracked_files_signal_vec() - unused convenience function

// ELIMINATED: tracked_files_count_signal() - use instance method instead

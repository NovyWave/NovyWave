    ...
    S: Signal<Item = bool> + Unpin + 'static + Clone,
{
    ...
    pub fn build(self) -> impl Element {
        ...
        let checkbox_box = El::new()
            ...
            .child_signal(self.checked_signal.clone().map(move |is_checked| {
                if is_checked {
...
impl CheckboxBuilder {
    pub fn build(self) -> impl Element {
        ...
        let checkbox_box = El::new()
            ...
            .s(Shadows::with_signal(if disabled {
            ...
            .s(Outline::with_signal_self(if disabled {
            ...
            .child_signal(checked_signal.map(move |is_checked| {
                match state {
                    CheckboxState::Indeterminate => {
                            ...
                            .child_signal(theme().map(move |t| {
                                IconBuilder::new(IconName::Minus)
                                    ...
                                    .color(if disabled {
                                        ...
                                        match t {
                                            Theme::Light => {
                                                IconColor::Custom("oklch(55% 0.22 250)")
                                            } // Blue color for light theme
                    ...
                    Column::new()
                        ...
                        .item_signal(always(self.description.clone()).map(move |desc| {
                            desc.map(|description| {
                                El::new().child(Text::new(&description)).s(Font::new()
                                    .size(font_size - 2)
                                    .weight(FontWeight::Number(FONT_WEIGHT_4))
                                    .color_signal(theme().map(move |t| {
                                        if disabled {

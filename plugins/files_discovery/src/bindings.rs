...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_paths_discovered_cabi<T: Guest>(arg0: *mut u8, arg1: usize) {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let base3 = arg0;
    let len3 = arg1;
...
pub trait Guest {
    ...
    fn paths_discovered(paths: _rt::Vec<_rt::String>) -> ();
...
macro_rules! __export_world_plugin_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        "paths-discovered")] unsafe extern "C" fn export_paths_discovered(arg0 : * mut
        u8, arg1 : usize,) { unsafe { $($path_to_types)*::
        _export_paths_discovered_cabi::<$ty > (arg0, arg1) } } #[unsafe (export_name =
        ...
        pub mod host {
            ...
            pub fn get_opened_files() -> _rt::Vec<_rt::String> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "novywave:files-discovery/host")]
                    unsafe extern "C" {
            ...
            pub fn register_watched_directories(
                directories: &[_rt::String],
                debounce_ms: u32,
            ) -> () {
                unsafe {
                    let vec1 = directories;
                    let len1 = vec1.len();
                    ...
                    #[link(wasm_import_module = "novywave:files-discovery/host")]
                    unsafe extern "C" {
                        #[link_name = "register-watched-directories"]
            ...
            pub fn clear_watched_directories() -> () {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "novywave:files-discovery/host")]
                    unsafe extern "C" {
                        #[link_name = "clear-watched-directories"]
                        fn wit_import0();
                    }
                    #[cfg(not(target_arch = "wasm32"))]
            ...
            pub fn open_waveform_files(paths: &[_rt::String]) -> () {
                unsafe {
                    let vec1 = paths;
                    let len1 = vec1.len();
                    let layout1 = _rt::alloc::Layout::from_size_align_unchecked(
            ...
            pub fn get_config_toml() -> _rt::String {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:novywave:files-discovery:plugin:encoded world"
)]
#[doc(hidden)]
...
A\x09\x01B\x0e\x01ps\x01@\0\0\0\x04\0\x10get-opened-files\x01\x01\x01@\x02\x0bdi\
rectories\0\x0bdebounce-msy\x01\0\x04\0\x1cregister-watched-directories\x01\x02\x01\
@\0\x01\0\x04\0\x19clear-watched-directories\x01\x03\x01@\x01\x05paths\0\x01\0\x04\
\0\x13open-waveform-files\x01\x04\x01@\0\0s\x04\0\x0fget-config-toml\x01\x05\x01\
@\x01\x07messages\x01\0\x04\0\x08log-info\x01\x06\x04\0\x09log-error\x01\x06\x03\
\0\x1dnovywave:files-discovery/host\x05\0\x01@\0\x01\0\x04\0\x04init\x01\x01\x04\
\0\x14refresh-opened-files\x01\x01\x01ps\x01@\x01\x05paths\x02\x01\0\x04\0\x10pa\
ths-discovered\x01\x03\x04\0\x08shutdown\x01\x01\x04\0\x1fnovywave:files-discove\
ry/plugin\x04\0\x0b\x0c\x01\0\x06plugin\x03\0\0\0G\x09producers\x01\x0cprocessed\
